...
<body>
	...
	<form id="payfrom" action="${hdpath }/unionpay/pay" method="post">
		...
		<input type="hidden" id="chargeparam" name="tempId" value="${defaultTemp}">
	</form>
	<div class="mui-row pay" align="center">
		<!-- <button class="mui-btn btn-pay" id="payButton">确认付款</button> -->
		<button class="mui-btn btn-pay" id="submitbtn">确认付款</button>
	</div>
	<div class="tip-cash">提示： 银联退款会在1-3个工作日内原路退回，如到期未到账，请联系商户！</div>
    ...
    $(document).ready(function(){
        ...
        $("#payButton").click(function() {
    		...
    		if (chargeparam == null || chargeparam == "") {
    			...
    			$.ajax({
        			url : "${hdpath}/unionpay/pay",
        			data : {
        				code : code,
        				merUserId : $("#merUserId").val(),
        				tempId : chargeparam,
        				unionUserId : $("#userid").val(),
        			},
        			type : "post",
        			dataType : "json",
        			beforeSend: function() {
