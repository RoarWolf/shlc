...
<div class="conditionsd">
  <form method="post" action="${hdpath}/pcequipment/selectEquipmentLog" id="listform">
    <div class="searchdiv">
      <input type="hidden" name="parm" value="1"/>
      <ul class="search" style="padding-left:10px;">
      		<li>
     		编号&nbsp;&nbsp;
     		<input type="text" placeholder="输入编号" name="equipmentnum" class="frame1" value="${equipmentnum}"/>
     		</li>
     		<li>
     		端口号&nbsp;&nbsp;
     		<input type="text" placeholder="输入端口号" name="port" class="frame1" value="${port}"/>
     		</li>
       		<li>
     		实时功率&nbsp;&nbsp;
     		...
     		<li>
			 时间:&nbsp;&nbsp;<input type="text" style="width:170px;" placeholder="请输入日期" name="startTime" id="startTime" value="${startTime}" class="inline laydate-icon">
				  —
				<input type="text" style="width:170px;" placeholder="请输入日期" name="endTime" id="endTime" value="${endTime}" class="inline laydate-icon">							 
			</li>
       		<li class="cmbquery">
