...
$(function() {
	...
	$('.monthlyBrnGary').click(function(){
		...
		$('.alert .alert_div p').html('进入公众号<span>"自助公众平台"-&gt;点击个人中心-&gt;进入页面点击个人中心-&gt;找到包月信息-&gt;</span>选择包月套餐点击确认充值按钮即可')
		$('.alert').fadeIn()
	})
	$('.rechType button').click(function(){
		$('.alert .alert_div h3').html('充值方式')
		$('.alert .alert_div p').html('进入公众号<span>"自助公众平台"-&gt;点击个人中心-&gt;进入页面点击个人中心-&gt;找到钱包充值-&gt;</span>选择金额点击充值按钮即可')
		$('.alert').fadeIn()
	})
