jQuery.bootstrapLoading = {
	start : function(options) {
		var defaults = {
			...
			//loading页面背景色
			loadindbackgroundColor : "rgb(35,33,33)",
			//loading背景颜色
			borderColor : "#bbb",
			//提示边框颜色
			borderWidth : 1,
		...
		var _LoadingHtml = '<div id="loadingPage" style="position:fixed;left:0;top:0;_position: absolute;width:100%;height:'
				...
				+ ';border:rgb(35,33,33);border-style:'
				+ options.borderStyle
				+ ';border-width:'
				+ options.borderWidth
				+ 'px; height:80px; line-height:80px; padding-left:25%; border-radius:6px;  background: '
				+ options.loadindbackgroundColor
				+ ' url(/images/load2.gif) no-repeat 13% center; color:'
				+ options.TipsColor
				+ ';font-size:14px;">'
